...
# ACDS 17.1 590 win32 2018.09.02.23:15:20
# ----------------------------------------
...
# ----------------------------------------
# If castInt_half is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "castInt_half"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/castInt_half.vo"
}
