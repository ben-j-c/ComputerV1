...
# ACDS 17.1 590 win32 2018.09.02.19:38:01
# ----------------------------------------
...
# ----------------------------------------
# If conv_fixed16ToHalf is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "conv_fixed16ToHalf"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/conv_fixed16ToHalf.vo"
}
