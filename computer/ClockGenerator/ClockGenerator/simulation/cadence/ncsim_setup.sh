...
TOP_LEVEL_NAME="ClockGenerator"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="G:/programs/altera/17.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ClockGenerator_sys_sdram_pll_0_sys_pll.vo"   -work sys_pll           -cdslib ./cds_libs/sys_pll.cds.lib          
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ClockGenerator_sys_sdram_pll_0.v"            -work sys_sdram_pll_0   -cdslib ./cds_libs/sys_sdram_pll_0.cds.lib  
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ClockGenerator.v"                                                                                                           
fi
