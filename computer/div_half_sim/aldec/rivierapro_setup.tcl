...
# ACDS 17.1 590 win32 2018.09.02.18:29:07
# ----------------------------------------
...
# ----------------------------------------
# If div_half is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/div_half_memoryC0_uid146_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/div_half_memoryC1_uid149_invTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/div_half.vo"
}
