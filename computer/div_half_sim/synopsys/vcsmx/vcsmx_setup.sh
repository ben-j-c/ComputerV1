...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/div_half_memoryC0_uid146_invTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/div_half_memoryC1_uid149_invTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/div_half.vo"
fi
